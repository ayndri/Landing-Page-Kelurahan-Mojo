...
<div class="max-w-3xl">
    ...
    <div class="bg-white rounded-xl shadow p-8">
        <div class="flex flex-wrap items-center justify-between gap-3 mb-6 pb-4 border-b">
            <h2 class="text-lg font-bold text-gray-800">Profil RW {{ $rwNumber }}</h2>
            <a href="{{ route('admin.barcode.rw', ['rw' => $rwNumber]) }}" target="_blank"
               class="bg-white border border-[#2d6a4f] text-[#2d6a4f] text-sm font-medium px-4 py-2.5 rounded-lg hover:bg-[#2d6a4f] hover:text-white transition flex items-center gap-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/></svg>
                Cetak Barcode Profil RW
            </a>
        </div>
